...
def main():
    ...
    parser.add_argument('-dataName', default='2009')
    parser.add_argument('-sq_len', type=int, default=20)
    parser.add_argument('-sq_space', type=int, default=5)
    ...
    parser.add_argument('-question_size', type=int, default=16891)
    ...
    pretrain_data = torch.utils.data.DataLoader(PretrainDataSet(pre_train_data, total_skill_data, difficult_dict,
                                                                opt.question_size, opt.skill_size, opt.sq_len),
