...
def main():
    ...
    if dataset == 'assist2009_updated':
        ...
        parser.add_argument('--qa_embed_dim', type=int, default=128, help='answer and question embedding dimensions')
        parser.add_argument('--memory_size', type=int, default=20, help='memory size')
        parser.add_argument('--n_question', type=int, default=12372, help='the number of unique questions in the dataset')
        parser.add_argument('--n_skill', type=int, default=188, help='the number of unique questions in the dataset')
    ...
    checkpoint = torch.load('../pretrain_chkpt/ednet-20.chkpt')
